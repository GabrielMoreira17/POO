...
public class PoorCat {
    ...
    private static final List<String> SIMBOLOS = Arrays.
            asList("Casa", "Sino", "Estrela", "Gato", "Coringa", "Aviao");
    ...
    private static Double calculaPremio(String a, String b, String c){
        if (a.equalsIgnoreCase("Coringa") && b.equalsIgnoreCase("Coringa") && c.equalsIgnoreCase("Coringa")){
    ...
    private static Double lerSaldo(Scanner sc){
        ...
        while (true){
            if (saldo > CUSTO_GIRO){
                ...
                System.out.println("O saldo deve ser maior que " + CUSTO_GIRO);
            }
        }
    }
    ...
    public static void main(String[] args) {
        ...
        System.out.println("O tigrinho esta pagando");
        Double saldo = lerSaldo(sc);
        int girosDesejados = lerGiros(sc);
        System.out.println("Simbolos disponíveis" + SIMBOLOS);
        System.out.println("Custo do giro" + CUSTO_GIRO);
        int girosEfetuados = 0;
        Random rng = new Random();

        while (girosEfetuados < girosDesejados && saldo >= CUSTO_GIRO)
        {
            girosEfetuados++;
            saldo =  saldo - CUSTO_GIRO;
            ...
            String resultado = ("Giro: " + girosEfetuados + ":Sorteado: ("+a+") ("+b+") ("+c+")");
            String detalhe;
            ...
            System.out.println(resultado + " = " + detalhe + " | Saldo: " + saldo);
        }
    ...
    if(saldo < CUSTO_GIRO && girosEfetuados < girosDesejados){
        System.out.println("Ficou sem saldo para realizar todos os giros desejados!");
    }
